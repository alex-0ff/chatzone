        ...
        <div className="chatbox">
            <div className="chatbox-nav">
                ...
                <div className="chatzone-nav-gauche">
                    <span>
                        <svg class="fa-secondary " fill="currentColor" height="22" width="22" viewBox="0 0 48 48">
                    ...
                    <div className="chat-user chat-me">                                        
                        <div className="date-username">
                            <div className="informations">
                                ...
                                <span class="name">Les fesses de Jean Marie Bigard</span>
                            </div>
                            <span class="time">21:04</span>
                        </div>
                        <span class="preview">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</span>
                    </div>
                </div>
                <div class="input">
                    <button class="fa-secondary">
