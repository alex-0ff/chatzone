...
function Navbar() {
    ...
    if(!jwt && history.location.pathname === "/settings") history.push("/login");
            ...
            <div className="header">
                ...
                <div className="gauche">
                    ...
                    <Link to="/explore" className="svg-link align-middle">
                        <svg aria-hidden="true" focusable="false" data-prefix="fad" role="img" viewBox="0 0 512 512">
                            <g>
                        ...
                        {
                            jwt ?  <Link to="/settings"><img src={pdp} className="pdp-navbar pdp-33" alt="" /></Link> : <Link to="/login" >Se connecter</Link>
                        }
